...
| [子代理与外部 AI Worker 编排](subagent-orchestration.md) | 规划复杂任务、选择或启动子代理/外部 AI worker、分配 ownership、判断模型/provider/effort 或处理中断恢复时 |
...
- 子代理的通用角色、上下文交接、模型/provider/effort 决策参考、ownership 和中断恢复由上表“子代理与外部 AI Worker 编排”管理；真实能力由当前平台/能力 owner 提供，项目只补充本项目特有边界。
